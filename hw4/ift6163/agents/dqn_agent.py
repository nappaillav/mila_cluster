...
from ift6163.policies.argmax_policy import ArgMaxPolicy
from ift6163.critics.dqn_critic import DQNCritic
...
class DQNAgent(object):
    ...
    def step_env(self):
        ...
        if perform_random_action:
            ...
            action = self.actor.get_action(np.expand_dims(self.replay_buffer.encode_recent_observation(), axis=0))
